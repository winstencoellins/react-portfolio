    ...
    <div className="projects">
        <div className="software-project">
            ...
            <ul className="list-swe-projects">
                <li className="swe-project">
                    <a href="https://bit.ly/3z2LHmn"><p className="grow swe-project-title">IP Address Tracker</p></a>
                ...
                <li className="swe-project">
                    <a href="https://bit.ly/3LmTVIH"><p className="grow swe-project-title">URL Shortener Landing Page</p></a>
                    <p>
                ...
                <li className="swe-project">
                    <a href="https://bit.ly/3GMsxDf"><p className="grow swe-project-title">Advice App Generator</p></a>
                    <p>
        ...
        <div className="data-project">
            ...
            <ul className="list-data-projects">
                <li>
                    <a href={finalReport}><p className="grow data-project-title">New York Rental Housing Prices</p></a>
